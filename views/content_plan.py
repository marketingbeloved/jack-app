...
# Июнь и июль убраны из календаря (прошли) — их данные в базе СОХРАНЕНЫ, просто не показываются.
# Сентябрь пустой: постов в базе нет, ячейки отрисуются прочерками — заполняется через «➕ Добавить пост».
VIEWS = {
    "Август + Сентябрь 2026": [(2026, 8), (2026, 9)],
    "Август 2026":            [(2026, 8)],
    "Сентябрь 2026":          [(2026, 9)],
}
